...
module English
  ...
  public
    ...
    def self.double_metaphone(string)
      string = string.to_s
      @db_memo ||= Hash.new
      @db_memo[string] = calculate_double_metaphone(string)
    end

  private

    def self.calculate_double_metaphone(str)
